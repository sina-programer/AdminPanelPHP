...
<head>
    <?php include(get_url('elements', 'html-head.php?title=' . urlencode('اضافه کردن محصول'))); ?>
</head>
                                ...
                                <div class="card-block row w-100 m-0">
                                    ...
                                    <div class="col-md-4 col-6 p-2">
                                        <div class="form-group">
                                            ...
                                            placeholder="قیمت تخفیف محصول را وارد کنید...">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-block row w-100 m-0">
                                    <div class="col-md-4 col-6 p-2">
                                        <div class="form-group">
                                            ...
                                            rows="3" placeholder="ویژگی های محصول را وارد کنید..."></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-6 p-2">
                                        <div class="form-group">
                                            ...
                                            rows="3" placeholder="نکات استفاده محصول را وارد کنید..."></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-6 p-2">
                                        <div class="form-group">
                                            ...
                                            rows="3" placeholder="توضیحات سئو را وارد کنید..."></textarea>
                                        </div>
                                    </div>
                                </div>
