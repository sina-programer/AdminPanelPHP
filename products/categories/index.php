...
$categories = $connection->query("SELECT * FROM product_categories $filter_clause ORDER BY id DESC")->fetchAll();
...
<head>
    <?php include(get_url('elements', 'html-head.php?title=' . urlencode('دسته بندی محصولات'))); ?>
</head>
                        ...
                        <div class="row align-items-center">
                            <div class="border-0 mb-4">
                                ...
                                <form action="<?php echo get_url('_search.php') ?>" method="POST" class="mb-3">
                                    <input type="hidden" name="url" value="<?php echo get_url('products', 'categories', 'index.php') ?>">
