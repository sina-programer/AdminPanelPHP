...
$banners = $connection->query("SELECT * FROM banners $filter_clause ORDER BY id DESC")->fetchAll();
...
<head>
    <?php include(get_url('elements', 'html-head.php?title=بنرها')); ?>
</head>
                        ...
                        <div class="row align-items-center">
                            <div class="border-0 mb-4">
                                ...
                                <form action="<?php echo get_url('_search.php') ?>" method="POST" class="mb-3">
                                    <input type="hidden" name="url" value="<?php echo get_url('banners', 'index.php')?>">
                                ...
                                <table id="myDataTable"
                                    ...
                                    <tbody class="text-center text-light">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <img src="<?php echo get_url('images', $banner['mobile_image']) ?>" width='100'>
                                            </th>
                                            <th>
                                                <img src="<?php echo get_url('images', $banner['desktop_image']) ?>" width='100'>
                                            </th>
                                            <th>
                                                <div class="btn-group" role="group">
                                                    <a href="_delete.php?id=<?php echo $banner['id'] ?>" class="btn rounded-custom btn-custom-b">
                                                        <i class="bi bi-trash d-flex text-white"></i>
                                                    </a>
                                                </div>
                                                <div class="btn-group" role="group">
                                                    <a href="edit.php?id=<?php echo $banner['id'] ?>" class="btn rounded-custom btn-custom-b">
