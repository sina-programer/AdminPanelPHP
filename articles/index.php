...
$articles = $connection->query("SELECT * FROM articles $filter_clause ORDER BY id DESC")->fetchAll();
...
<head>
    <?php include(get_url('elements', 'html-head.php?title=مقالات')); ?>
</head>
                        ...
                        <div class="row align-items-center">
                            <div class="border-0 mb-4">
                                ...
                                <form action="<?php echo get_url('_search.php'); ?>" method="POST" class="mb-3">
                                    <input type="hidden" name="url" value="<?php echo get_url('articles', 'index.php')?>">
                                    <h5 class="fw-bolder mb-1">جستجو</h5>
                                    <div class="container-fluid">
                                        <div class="card-block row w-100 m-0">
                                            <div class="form-group col-md-3 col-6 p-3">
                                                <label>عنوان</label>
                                            ...
                                            <div class="form-group col-md-3 col-6 p-3">
                                                ...
                                                placeholder="جستجو با نام نویسنده...">
                                            </div>
                                    ...
                                    <tbody class="text-center text-light">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <img src="<?php echo get_url('images', $article['image']); ?>" width='100'>
                                            </th>
                                            <th>
                                                <span class="badge bg-custom" style="color: #000; font-size: 13px">
                                                    <?php echo $article['publish_date']?>
                                                </span>
                                            </th>
                                            <th>
                                                <span class="badge <?php if($article['status']==1){echo 'bg-success';}else{echo 'bg-danger';}?>" style="font-size: 14px">
                                                    <?php
                                                        if ($article['status'] == 1){
                                                            echo 'فعال';
                                                        }else{
                                            ...
                                            <th>
                                                <div class="btn-group" role="group">
                                                    <a href="_delete.php?id=<?php echo $article['id'] ?>" class="btn rounded-custom btn-custom-b">
                                                        <i class="bi bi-trash d-flex text-white"></i>
                                                    </a>
                                                </div>
                                                <div class="btn-group" role="group">
                                                    <a href="edit.php?id=<?php echo $article['id'] ?>" class="btn rounded-custom btn-custom-b">
