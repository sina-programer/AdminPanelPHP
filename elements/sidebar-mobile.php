...
<div class="header bg-white px-0 py-3 border mt-lg-4 mt-md-3 mt-sm-2 mt-1 rounded-custom shadow d-lg-none d-block">
    <div class="row w-100 m-0">
        <div class="col-md-1 col-sm-2 col-3 text-center align-self-center p-2">
        ...
        <div class="col-md-8 col-sm-5 col-3 align-self-center p-2"></div>
        <div class="col-md-3 col-sm-5 col-6 text-center align-self-center p-2">
            <a class="text-danger d-flex align-items-center justify-content-end mx-3" href="/logout">
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasderawer"
