...
$jscomp.polyfill = function (t, e, n, r) {
    ...
    function (n) {
        ...
        function T(t) {
            var e, n, r, a;
            Qt.__browser || (Qt.__browser = e = {}, a = (r = (n = P("<div/>").css({
                position: "fixed",
                top: 0,
                ...
                width: "100%",
                height: 10
            }))).appendTo("body")).children()).children(), e.barWidth = r[0].offsetWidth - r[0].clientWidth, e.bScrollOversize = 100 === a[0].offsetWidth && 100 !== r[0].clientWidth, e.bScrollbarLeft = 1 !== Math.round(a.offset().left), e.bBounding = !!n[0].getBoundingClientRect().width, n.remove()), P.extend(t.oBrowser, Qt.__browser), t.oScroll.iBarWidth = Qt.__browser.barWidth
        }
        ...
        function x(t, e) {
            ...
            t.aoColumns.push(n), (n = t.aoPreSearchCols)[r] = P.extend({}, Qt.models.oSearch, n[r]), C(t, r, P(e).data())
        }
        ...
        function s(t) {
            for (var e = t.aoColumns, n = t.aoData, r = Qt.ext.type.detect, a = 0, o = e.length; a < o; a++) {
                var i = e[a],
                    s = [];
        ...
        function t(t) {
            ...
            }), n("iSortingCols", l.length)), null === (e = Qt.ext.legacy.ajax) ? t.sAjaxSource ? s : d : e ? s : d
        }
        ...
        function J(t) {
            for (var e, n, r = Qt.ext.search, a = t.aiDisplay, o = 0, i = r.length; o < i; o++) {
        ...
        function K(t) {
            for (var e = t.aoColumns, n = Qt.ext.type.search, r = !1, a = 0, o = t.aoData.length; a < o; a++) {
                var i = t.aoData[a];
                if (!i._aFilterData) {
        ...
        function It(t, e) {
            ...
            for (var o, i = Qt.ext.type.order[r.sType + "-pre"], s = 0, l = t.aoData.length; s < l; s++)(r = t.aoData[s])._aSortData || (r._aSortData = []), r._aSortData[e] && !a || (o = a ? n[s] : F(t, s, e, "sort"), r._aSortData[e] = i ? i(o) : o)
        }
        ...
        function Ft(t, e, n, r) {
            ...
            else if (e = (e = Qt.ext).sErrMode || e.errMode, t && kt(t, null, "error", [t, r, n]), "alert" == e) alert(n);
            else {
        ...
        function Mt(t, e) {
            var n = Fe.numbers_length,
                r = Math.floor(n / 2);
            return e <= n ? t = zt(0, e) : t <= r ? ((t = zt(0, n - 2)).push("ellipsis"), t.push(e - 1)) : (e - 1 - r <= t ? t = zt(e - (n - 2), e) : ((t = zt(t - r + 2, t + r - 1)).push("ellipsis"), t.push(e - 1)), t.splice(0, 0, "ellipsis"), t.splice(0, 0, 0)), t.DT_el = "span", t
        }
        ...
        function Wt(n) {
            P.each({
                ...
                Jt.type.order[t + n + "-pre"] = e, t.match(/^html\-/) && (Jt.type.search[t + n] = Jt.type.search.html)
            })
        }
        ...
        function Vt(t, e, n) {
            ...
            return !!Bt(t) || (e && r && (t = oe(t, e)), n && r && (t = t.replace(ae, "")), !isNaN(parseFloat(t)) && isFinite(t))
        }

        function Xt(t, e, n) {
            return !!Bt(t) || ((Bt(t) || "string" == typeof t) && !!Vt(t.replace(ee, ""), e, n) || null)
        }
        ...
        var Jt, Gt, Zt, Qt = function (b) {
                ...
                var t, m = this,
                    v = b === R,
                    y = this.length;
                for (t in v && (b = {}), this.oApi = this.internal = Jt.internal, Qt.ext.internal) t && (this[t] = e(t));
            ...
            te = /[\r\n\u2028]/g,
            ee = /<.*?>/g,
            ne = /^\d{2,4}[\.\/\-]\d{1,2}[\.\/\-]\d{1,2}([T ]{1}\d{1,2}[:\.]\d{2}([\.:]\d{2})?)?$/,
            re = /(\/|\.|\*|\+|\?|\||\(|\)|\[|\]|\{|\}|\\|\$|\^|\-)/g,
            ae = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi,
            oe = function (t, e) {
                return Kt[e] || (Kt[e] = new RegExp(fe(e), "g")), "string" == typeof t && "." !== e ? t.replace(/\./g, "").replace(Kt[e], ".") : t
            },
            ie = function (t, e, n) {
                var r = [],
                    a = 0,
        ...
        Qt.Api = ye, P.extend(ye.prototype, {
            any: function () {
                return 0 !== this.count()
            },
            concat: ve.concat,
        ...
        }, ye.registerPlural = Zt = function (t, e, n) {
        ...
        var xe = function (t, e) {
            var n = [],
                ...
                o = e.search,
                i = e.order;
            if (e = e.page, "ssp" == Ht(t)) return "removed" === o ? [] : zt(0, a.length);
            if ("current" == e)
        ...
        Gt("rows()", function (e, n) {
            ...
            var t = this.iterator("table", function (t) {
                return De("row", e, function (n) {
                    ...
                    return "string" == typeof n && "#" === n.charAt(0) && (t = a.aIds[n.replace(/^#/, "")]) !== R ? [t.idx] : (t = Yt(qt(a.aoData, i, "nTr")), P(t).filter(n).map(function () {
        ...
        function Ce(a, t, e, n) {
            function o(t, e) {
                ...
                else t.nodeName && "tr" === t.nodeName.toLowerCase() ? i.push(t) : (n = P("<tr><td></td></tr>").addClass(e), P("td", n).addClass(e).html(t)[0].colSpan = v(a), i.push(n[0]))
            }
            var i = [];
        ...
        function Ie(t, e) {
            var a, n, o, r = t.context;
            r.length && t.length && ((t = r[0].aoData[t[0]])._details && ((t._detailsShow = e) ? t._details.insertAfter(t.nTr) : t._details.detach(), a = r[0], n = new ye(a), o = a.aoData, n.off("draw.dt.DT_details column-visibility.dt.DT_details destroy.dt.DT_details"), 0 < ie(o, "_details").length && (n.on("draw.dt.DT_details", function (t, e) {
                a === e && n.rows({
                    page: "current"
        ...
        Gt("row().child()", function (t, e) {
            var n = this.context;
            return t === R ? n.length && this.length ? n[0].aoData[this[0]]._details : R : (!0 === t ? this.child.show() : !1 === t ? Ae(this) : n.length && this.length && Ce(n[0], n[0].aoData[this[0]], t, e), this)
        ...
        Gt("columns()", function (n, r) {
            ...
            return this.iterator("column-rows", function (t, e, n, r, a) {
                return qt(t.aoData, a, "search" === o ? "_aFilterData" : "_aSortData", e)
            }, 1)
        ...
        Gt("cells()", function (g, t, b) {
            if (P.isPlainObject(g) && (g.row === R ? (b = g, g = null) : (b = t, t = null)), P.isPlainObject(t) && (b = t, t = null), null === t || t === R) return this.iterator("table", function (t) {
                return n = t, e = g, r = we(b), d = n.aoData, f = xe(n, r), t = Yt(qt(d, f, "anCells")), h = P(le([], t)), p = n.aoColumns.length, De("cell", e, function (t) {
        ...
        }), Gt("orders.listener()", function (e, n, r) {
            return this.iterator("table", function (t) {
                xt(t, e, n, r)
            })
        }), Gt("orders.fixed()", function (e) {
        ...
        }), Gt(["columns().orders()", "column().orders()"], function (r) {
            var a = this;
            ...
            for (var e, n, r = Qt.version.split("."), a = 0, o = (t = t.split(".")).length; a < o; a++)
            ...
            return t ? new ye(n) : n
        }, Qt.camelToHungarian = S, Gt("$()", function (t, e) {
        ...
        }), Qt.version = "1.10.22", Qt.settings = [], Qt.models = {}, Qt.models.oSearch = {
            bCaseInsensitive: !0,
            sSearch: "",
            bRegex: !1,
            bSmart: !0
            ...
            oLanguage: {
                ...
                sInfo: "نمایش _START_ از _END_ از _TOTAL_ ورودی",
                sInfoEmpty: "نمایش 0 از 0 از 0 ورودی",
            ...
            renderer: null,
            rowId: "DT_RowId"
        }, i(Qt.defaults), Qt.defaults.column = {
            aDataSort: null,
            iDataSort: -1,
            asSorting: ["asc", "desc"],
            bSearchable: !0,
            ...
            sType: null,
            sWidth: null
        }, i(Qt.defaults.column), Qt.models.oSettings = {
            oFeatures: {
                bAutoWidth: null,
                bDeferRender: null,
                bFilter: null,
        ...
        P.extend(Fe, {
            ...
            pageButton: {
                _: function (l, t, c, e, u, d) {
                    function f(t, e) {
                        ...
                        for (var r = g.sPageButtonDisabled, a = 0, o = e.length; a < o; a++) {
                            var i = e[a];
                            if (Array.isArray(i)) {
                                ...
                                switch (h = null, p = i, s = l.iTabIndex, i) {
                                    ...
                                    case "previous":
                                        ...
                                        break;
                                    case "next":
                                        h = b.sNext, 0 !== d && u !== d - 1 || (s = -1, p += " " + r);
                                        break;
                                    case "last":
                                        h = b.sLast, 0 !== d && u !== d - 1 || (s = -1, p += " " + r);
                                        break;
                                    default:
            ...
            return (!t || t instanceof Date || ne.test(t)) && (null !== (e = Date.parse(t)) && !isNaN(e) || Bt(t)) ? "date" : null
        }, function (t, e) {
            return e = e.oLanguage.sDecimal, Vt(t, e, !0) ? "num-fmt" + e : null
        }, function (t, e) {
            return e = e.oLanguage.sDecimal, Xt(t, e) ? "html-num" + e : null
        }, function (t, e) {
            return e = e.oLanguage.sDecimal, Xt(t, e, !0) ? "html-num-fmt" + e : null
        }, function (t, e) {
            return Bt(t) || "string" == typeof t && -1 !== t.indexOf("<") ? "html" : null
        }]), P.extend(Qt.ext.type.search, {
            html: function (t) {
                return Bt(t) ? t : "string" == typeof t ? t.replace(te, " ").replace(ee, "") : ""
            },
            string: function (t) {
        ...
        function Pe(t, e, n, r) {
            return 0 === t || t && "-" !== t ? ((t = e ? oe(t, e) : t).replace && (n && (t = t.replace(n, "")), r && (t = t.replace(r, ""))), +t) : -1 / 0
        }
        ...
        }), Wt(""), P.extend(!0, Qt.ext.renderer, {
            header: {
                _: function (a, o, i, s) {
                    P(a.nTable).on("orders.dt.DT", function (t, e, n, r) {
                ...
                jqueryui: function (a, o, i, s) {
                    P("<div/>").addClass(s.sSortJUIWrapper).append(o.contents()).append(P("<span/>").addClass(s.sSortIcon + " " + i.sSortingClassJUI)).appendTo(o), P(a.nTable).on("orders.dt.DT", function (t, e, n, r) {
        ...
        d.extend(n.prototype, {
            ...
            _classLogic: function () {
                function s(t, e, n, r) {
                    if (n) {
                        if ("max-" === n)
                            for (r = a._find(e).width, e = 0, n = l.length; e < n; e++) l[e].width <= r && i(t, l[e].name);
                        else if ("min-" === n)
                            for (r = a._find(e).width, e = 0, n = l.length; e < n; e++) l[e].width >= r && i(t, l[e].name);
                        else if ("not-" === n)
                            for (e = 0, n = l.length; e < n; e++) - 1 === l[e].name.indexOf(r) && i(t, l[e].name)
